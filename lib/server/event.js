...
const FileStreamer		= require( './middlewares/file_streamer' );
/**
...
class RequestEvent
{
	 ...
	 * @param	String file
	 *
	 * @TODO	SHOULD GET A FILE STREAMER HANDLER INSIDE
	 *
	 * @return	void
	 */
	streamFile( file )
	{
		let fileStreamer	= new FileStreamer( this, {} );
		fileStreamer.stream( file );
	}
}
